-- Codice targa sequenziale esadecimale: parte da 001 (salta 000)
...
comment on column public.fornitori.codice_targa is
  'Identificativo sequenziale a 3 caratteri esadecimali (001-FFF), assegnato al salvataggio';
