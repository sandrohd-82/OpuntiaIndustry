...
| `20260905160000` | `organigramma_reparti.sql` | Organigramma: catalogo reparti + FK persona |
| `20260905170000` | `organigramma_certificati_scadenze.sql` | Certificati: catalogo titoli, scadenze, stato in forza |

**Prossimo timestamp libero: `20260905180000` o successivo (sempre maggiore dell’ultimo).**
