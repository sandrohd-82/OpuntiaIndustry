...
export async function createAttivitaAction(
  ...
  const insert: AttivitaInsert = {
    ...
    kg_per_ora: normalized.kgPerOra ?? 1,
    ore_giorno: normalized.oreGiorno ?? 8,
    modalita_tempo: normalized.modalitaTempo ?? "throughput",
    ore_ciclo: normalized.oreCiclo ?? null,
    quantita_modo: normalized.quantitaModo ?? null,
    quantita_valore: normalized.quantitaValore ?? null,
